...
class Config:
    ...
    def set_gas_price(self, price_gwei: float) -> None:
...
def add_history(token: str, to_addr: str, amt: float, tx_hash: str) -> int:
...
def copy_all_transactions_hashes() -> str:
...
def add_found_transaction(tx_data: Dict[str, Any], search_info: Dict[str, Any]) -> int:
...
def add_reward(address: str, plex_amount: float, usdt_amount: float, tx_hash: Optional[str] = None) -> int:
...
def get_unrewarded_transactions(sender_addr: Optional[str] = None) -> List[Any]:
...
def get_transactions_by_sender(sender_addr: str) -> List[Any]:
...
def fetch_found_transactions(limit: int = 1000) -> List[Any]:
...
def get_sender_transaction_counts() -> List[Any]:
...
def add_mass_distribution(name: str, token_address: str, token_symbol: str, amount_per_tx: float, 
                        total_addresses: int, total_cycles: int, interval_seconds: int) -> int:
...
def add_mass_distribution_item(distribution_id: int, address: str, cycle: int, tx_hash: str, 
...
def get_mass_distributions(limit: int = 100) -> List[Any]:
...
def get_mass_distribution_items(distribution_id: int) -> List[Any]:
...
def get_mass_distribution_statistics(distribution_id: int) -> Dict[str, int]:
...
# ======== #MCP:API ========
@retry(times=3)
def bscscan_request(params: Dict[str, Any]) -> List[Dict[str, Any]]:
...
# ======== Постраничный анализ ========
def search_transactions_paginated(wallet_address: str, token_contract: Optional[str] = None, 
                                 exact_amount: Optional[float] = None, min_amount: Optional[float] = None, 
                                 max_amount: Optional[float] = None, page_size: int = 1000, 
                                 max_pages: int = 100, delay_seconds: int = 1, 
                                 stop_flag: Optional[threading.Event] = None, 
                                 track_individual_tx: bool = False) -> Tuple[List[Dict[str, Any]], Dict[str, int], Optional[Dict[str, List[Dict[str, Any]]]]]:
    """
...
def get_token_decimal(token_address: str) -> int:
