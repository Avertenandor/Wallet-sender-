...
# Типы данных для статистики ключей API
...
class TransactionData(TypedDict, total=False):
    hash: str
    from_address: str  # Изменил from на from_address
    to: str
    value: str
    contractAddress: str
    tokenSymbol: str
...
• 🔄 Перезапустите приложение после установки
    ...
    def _tab_mass_distribution(self):
        ...
        header = self.mass_addresses_table.horizontalHeader()
        if header:
            header.setSectionResizeMode(QtWidgets.QHeaderView.Stretch)
        ...
        self.mass_distribution_active: bool = False
        self.mass_distribution_paused: bool = False
        self.mass_distribution_thread: Optional[threading.Thread] = None
        self.mass_addresses: List[str] = []
        self.mass_current_distribution_id: Optional[int] = None
