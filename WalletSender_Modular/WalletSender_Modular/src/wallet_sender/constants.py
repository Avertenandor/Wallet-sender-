...
# Token decimals (for known tokens to avoid constant queries)
TOKEN_DECIMALS: Dict[str, int] = {
    '0xdf179b6cadbc61ffd86a3d2e55f6d6e083ade6c1': 9,   # PLEX ONE - ВАЖНО: 9 decimals, не 18!
...
TAB_TITLES: Dict[str, str] = {
    'analyze': '[SEARCH] Анализ токенов',
    'search': '🔎 Поиск транзакций', 
    'rewards': '🎁 Награды',
    'tx_rewards': '[MONEY] Награды за Tx',
    'direct_send': '📫 Прямая отправка',
    'mass_distribution': '[MASS] Массовая рассылка',
    'mass_distribution2': '[MASS] Массовая рассылка 2',
    'mass_distribution3': '[MASS] Массовая рассылка 3',
    'queue': '[INFO] Очередь',
    'history': '[HISTORY] История',
    'found_tx': '[SEARCH] Найденные Tx',
    'settings': '[SETTINGS] Настройки',
    'auto_sales': '[MONEY] Автопродажи',
