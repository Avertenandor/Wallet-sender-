...
class HistoryTab(BaseTab):
    ...
    def init_ui(self):
        ...
        # Заголовок
        header = QGroupBox("[HISTORY] История транзакций")
        ...
        self.check_status_btn = QPushButton("[OK] Проверить статусы")
    ...
    def check_pending_statuses(self):
        ...
        try:
            ...
            self.status_checker.finished.connect(
                lambda: self.check_status_btn.setText("[OK] Проверить статусы")
            )
    ...
    def show_context_menu(self, position):
        ...
        copy_address_action = menu.addAction("[INFO] Копировать адрес")
        menu.addSeparator()
