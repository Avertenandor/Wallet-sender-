...
class RewardsTab(BaseTab):
    ...
    def _create_rewards_panel(self) -> QWidget:
        ...
        # Заголовок
        layout.addWidget(QLabel("[INFO] Список наград для отправки"))
        ...
        self.export_csv_btn = QPushButton("[SEND] Экспорт в CSV")
        ...
        self.remove_selected_btn = QPushButton("[ERROR] Удалить выбранные")
    ...
    def _create_control_panel(self) -> QWidget:
        ...
        self.save_config_btn = QPushButton("[SAVE] Сохранить")
        ...
        self.send_rewards_btn = QPushButton("[START] Отправить выбранные награды")
    ...
    def import_from_csv(self):
        ...
        try:
            ...
            self.log(f"[OK] Импортировано {imported_count} наград", "SUCCESS")
    ...
    def export_to_csv(self):
        ...
        try:
            ...
            self.log(f"[OK] Экспортировано {len(self.rewards_list)} наград", "SUCCESS")
    ...
    def start_sending_rewards(self):
        ...
        try:
            ...
            self.log(f"[START] Задача отправки {len(selected_rewards)} наград добавлена в очередь (ID: {self.current_job_id})", "SUCCESS")
    ...
    def _on_job_completed(self, job_id: int):
        ...
        self._log_operation("[FINISH] Отправка наград завершена успешно")
    ...
    def _on_job_failed(self, job_id: int):
        ...
        self._log_operation("[ERROR] Отправка наград завершилась с ошибкой")
    ...
    def _show_context_menu(self, position):
        ...
        copy_address = menu.addAction("[INFO] Копировать адрес")
        copy_tx = menu.addAction("[INFO] Копировать TX hash")
        menu.addSeparator()
        open_bscscan = menu.addAction("[WEB] Открыть TX в BscScan")
        menu.addSeparator()
        resend = menu.addAction("🔄 Отправить повторно")
        remove = menu.addAction("[ERROR] Удалить")
